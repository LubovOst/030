          ...
          <div class="row no-gutters align-items-center pt-60px">
            ...
            <div class="col-sm-7 col-lg-6 offset-lg-1 pl-4 pl-md-5 pl-lg-0">
              <div class="hero-banner__content">
                ...
                <h1>Магазин "ТоварыОнлайн"</h1>
                <p>
                  Предлагает вам накопительную скидку 25%. Дополнительный бонус
                  после регистрации.
                </p>
                <a class="button button-hero" href="#">Зарегистрироваться</a>
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="card card-blog">
                ...
                <div class="card-body">
                  <ul class="card-blog__info">
                    ...
                    <li>
                      <a href="#"
                        ><i class="ti-comments-smiley"></i> 2 Comments</a
                      >
                    </li>
                  </ul>
                  <h4 class="card-blog__title">
                    <a href="single-blog.html"
                      >The Richland Center Shooping News and weekly shooper</a
                    >
                  </h4>
                  <p>
